...
class UserController extends Controller
{
    public function packageUpgrade()
    {
        ...
        return view('user_old.settings.packages', compact('title', 'grades', 'user', 'packages'));
    }
...
//        dd(json_decode($json_array));
    ...
    public function profile()
    {
        ...
        return view('user_old.settings.profile-show', compact('title', 'user'));
    }
...
//        $this->validationRules["current_password"] = 'required';
        ...
        return view('user_old.settings.password', compact('title',  'validator'));
    }
