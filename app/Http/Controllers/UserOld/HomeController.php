...
class HomeController extends Controller
{
    public function home()
    {
        ...
        return view('user_old.home', compact('title'));
    }
...
//        Log::critical(Carbon::createFromFormat('Y-m-d', '2021-07-01'));
        ...
        return view('user_old.levels', compact('title', 'grades', 'alternate_grades'));
    }
    ...
    public function subLevels($grade, $type)
    {
        ...
        return view('user_old.sub_levels', compact('title', 'type', 'grade', 'levels'));
    }
    ...
    public function subLessons($id, $type, $level = null)
    {
        ...
        return view('user_old.lessons', compact('grade', 'lessons'));
    }
...
//            $query->where('level', $level);
    ...
    {
        $user = Auth::guard('web')->user();
        $lesson = Lesson::query()->with(['grade', 'media'])
            ->whereDoesntHave('hiddenLessons',function ($query) use ($user){
                $query->where('school_id', $user->school_id);
            })
            ->where('id',$id)->first();
        ...
        switch ($key) {
            case 'learn':
                return view('user_old.lesson.learn', compact('lesson'));
            case 'training':
                ...
                return view('user_old.lesson.training', compact('lesson', 'tf_questions', 'c_questions', 'm_questions', 's_questions'));
            case 'test':
                ...
                return view('user_old.lesson.test', compact('questions', 'lesson'));
            default:
    ...
    public function certificates()
    {
        ...
        return view('user_old.certificates', compact('student_tests', 'title'));
    }
    ...
    public function certificate($id)
    {
        ...
        return view('user_old.new_certificate', compact('student_test', 'title'));
    }
    ...
    public function certificateAnswers($id)
    {
        ...
        return view('user_old.certificate_result', compact('student_test', 'title', 'questions'));
    }
    ...
    public function assignments()
    {
        ...
        return view('user_old.assignments', compact('student_assignments', 'title'));
    }
    ...
    public function storiesLevels()
    {
        ...
        return view('user_old.stories_levels', compact('title', 'levels', 'levels'));
    }
    ...
    public function stories($level)
    {
        ...
        return view('user_old.stories_list', compact('title', 'stories', 'level'));
    }
    ...
    public function story($id, $key)
    {
        ...
        switch ($key) {
            case 'watch':
                return view('user_old.story.learn', compact('story'));
            case 'read':
                ...
                $users_stories = StoryUserRecord::query()
                    ...
                    ->limit(10)
                    ->get();
                return view('user_old.story.training', compact('story', 'user_story', 'users_stories'));
            case 'test':
                $questions = StoryQuestion::query()->where('story_id', $id)->get();
                return view('user_old.story.test', compact('questions', 'story'));
            default:
                return redirect()->route('home');
        }
    }
    ...
    public function storiesAssignments()
    {
        ...
        return view('user_old.story_assignments', compact('student_assignments', 'title'));
    }
