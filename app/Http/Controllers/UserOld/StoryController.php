...
//    }
    ...
    public function storyTestResult($id)
    {
        ...
        return view('user_old.story.story_test_result',compact('student_test', 'title', 'level', 'story'));
    }
    ...
    public function certificates()
    {
        ...
        return view('user_old.story.certificates', compact('student_tests', 'title'));
    }
    ...
    public function certificate($id)
    {
        ...
        return view('user_old.story.new_certificate',compact('student_test', 'title'));
    }
    ...
    public function certificateAnswers($id)
    {
        ...
        return view('user_old.story.certificate_result',compact('student_test', 'title', 'questions'));
    }
}
