<!-- True/False Question -->
<div class="question-container" id="question{{$question->id}}" data-question-id="{{$question->id}}" data-question-type="true-false" style="display: {{$loop->iteration==1?'block':'none'}};">
    <div class="question-header">
        <div class="question-text">
            <h2 class="question-title">أكد إذا كانت هذه الجمل صواب ام خطأ</h2>
        </div>
    </div>
...
{{--                    </div>--}}
        ...
        <div class="true-false-options">
            <button class="true-false-btn true-btn" data-answer="true" data-question-id="{{$question->id}}">
                صح
            </button>
