<!-- Sorting Question -->
<div class="question-container" id="question{{$question->id}}" data-question-id="{{$question->id}}" data-question-type="sorting" style="display: {{$loop->iteration==1?'block':'none'}};">
    <div class="question-header">
        <div class="question-text">
            <h2 class="question-title">رتب الحروف لتكوين كلمة صحيحة</h2>
        </div>
    </div>
...
{{--                    </div>--}}
        ...
        <div class="drag-drop-container">
            ...
            <div class="order-drop-zone" id="orderDropZone_{{$question->id}}" data-question-id="{{$question->id}}" data-insert-direction="end"></div>
        </div>
