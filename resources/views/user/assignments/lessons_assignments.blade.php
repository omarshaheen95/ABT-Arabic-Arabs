            ...
            <div class="assignment-card" data-assignment-id="{{$student_assignment->id}}">
                <div class="card-header">
                    ...
                    <div style="display: flex; flex-direction: column; align-items: center;">
                        ...
                        @endif
                        <a href="{{route('lesson.lesson-index',['id'=>$student_assignment->lesson_id,'key'=>'learn'])}}" class="btn-outline glass-button-component btn-sm" style="margin-top: 6px; font-size: 12px; color: var(--primary-color)">
                    ...
                    <div class="action-menu-wrapper">
                        ...
                        <div class="action-menu" id="actionMenu-1">
                            ...
                            <button class="action-menu-item"
                                    onclick="goToTest('{{route('lesson.lesson-index',['id'=>$student_assignment->lesson_id,'key'=>'learn'])}}')">
                                اذهب الى الدرس
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 14.5v-9l6 4.5-6 4.5z" fill="currentColor"/>
                                </svg>
