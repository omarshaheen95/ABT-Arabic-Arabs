...
<div class="page no-page-break position-relative p-0 d-flex justify-content-center">
    ...
    <div class="subpage no-page-break">
        ...
        <div class="d-flex flex-column align-items-center gap-1" style="padding-top: 40px">
            ...
            <div class="d-flex flex-column justify-content-center gap-1 text-center">
                <h6 class="s-text">In appreciation of passing the assessment of lesson : <br> <span class="s-s-text" dir="rtl">{{$student_test->lesson->name}}</span></h6>
                <h6 class="s-text">in the level {{$student_test->lesson->grade->name}}</h6>
                <h6 class="s-text">with the percentage of {{$student_test->total_per}}</h6>
                <h6 class="s-text">During the journey of learning Arabic from the Arabic Arabs platform.</h6>
            </div>
