        ...
        <div class="certificates-table-wraper">
            ...
            <table class="certificates-table">
                ...
                @foreach($student_tests as $student_test)
                    <tr>
                        <td class="lesson-name">{{$student_test->story->name}}</td>
                ...
                <div class="card-content">
                    <div class="card-progress">
                        <div class="progress-linear-container">
                            ...
                            <div class="progress-linear-bar" style="width: {{$student_test->total_per}}; background: {{$student_test->status == 'Pass' ? 'linear-gradient(90deg, #39D670, #B3E69E)' : 'linear-gradient(90deg, #FFC107, #FFE082)'}};"></div>
