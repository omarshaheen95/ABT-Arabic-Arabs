...
@section('page-name', 'story-test')

@section('content')
    <div class="quiz-container">
        <div id="quizContent">
            <h1 class="quiz-title">{{$story->name}}</h1>
            <div class="quiz-content-wrapper">
                ...
                <form id="testForm" method="POST" action="{{route('story.save-test', $story->id)}}">
                    @csrf
...
@push('script')
    ...
    <script src="{{asset('user_assets/js/pages/test.js')}}"></script>
