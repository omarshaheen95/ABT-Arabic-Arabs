        ...
        <div class="quiz-result-content-wraper">
            <div class="quiz-result-content-container">
                ...
                <div class="result-header">
                    <h1 class="result-title-ar" style="margin-bottom: 20px;!important;">{{$story->name}}</h1>
                ...
                <div class="congratulations-section">
                    ...
                    @else
                        <p class="congrats-text-ar">
                            درجتك في هذا التقييم هي {{$percentage}}%. تحتاج إلى 25% للنجاح. يرجى المحاولة مرة أخرى.
                        </p>
                        <p class="congrats-text-en">
                            Your score in this assessment is {{$percentage}}%. You need 25% to pass. Please try again.
                        </p>
                    @endif
                </div>
                ...
                <div class="result-actions">
                    ...
                    @endif
                    <button class="result-btn next-lesson-btn" data-url="{{$next_story_url}}">Next Story</button>
                </div>
            </div>
        </div>
    </div>
