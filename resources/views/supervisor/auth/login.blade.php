...
@section('content')
    <section>
        <div class="form">
            <div class="form-card">
                <form id="login-form" action="/supervisor/login" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="header">
                        ...
                        <a href="/" class="back">
                            <img src="{{asset('assets_v1/assets_v1/web_assets/img/close.svg')}}" class="img-fluid" alt="close">
                        </a>
                    </div>
                    <div class="info">
                        <h1 class="title">{{t('Supervisor Login')}} </h1>
                    </div>
                    <div class="body">
                        ...
                        <div class="form-group">
                            <div class="d-flex">
                                ...
                                <a class="ms-auto text-theme" href="/supervisor/password/reset" style="font-size: 13px">{{t('Reset Password')}}</a>
                            </div>
                            <div class="form-control-icon">
                                <div class="icon">
                                    <svg id="Icon" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
...
@endsection
@section('script')
    <script src="{{asset('assets/js/browserInfo.js')}}"></script>
@endsection
