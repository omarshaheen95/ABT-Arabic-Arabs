...
@section('content')
    <form enctype="multipart/form-data" id="form_information"
          action="{{ route('manager.lessons_tests.correct', $user_test->id) }}" method="post">
        @csrf
        ...
        $("#form_information").submit(function (e) {
            ...
            function uploadBlob(testerAudio) {
                ...
                reader.onload = function (event) {
                    ...
                    console.log(fd);
                    $.ajax({
                        url: '{{ route('manager.lessons_tests.correct', $user_test->id) }}',
                        data: fd,
                        processData: false,
                        contentType: false,
                        type: 'POST',
                        ...
                        setTimeout(function () {
                            window.location.href = "{{route('manager.lessons_tests.index')}}";
                        }, 500);
                    });
                };
