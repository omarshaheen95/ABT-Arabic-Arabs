        ...
        <ul class="dropdown-menu">
            @can('export lesson assignments')
                <li><a class="dropdown-item" href="#!"
                       onclick="excelExport('{{route(getGuard().'.user_lesson_assignment.export')}}')">{{t('Export')}}</a></li>
            @endcan
...
@section('filter')
    <div class="row">
        ...
        @if(request()->get('lesson_assignment_id'))
            <input type="hidden" name="lesson_assignment_id" value="{{request()->get('lesson_assignment_id')}}">
        @endif
    </div>
@endsection
...
@section('script')
    ...
    <script>
        var DELETE_URL = "{{ route(getGuard().'.user_lesson_assignment.destroy') }}";
